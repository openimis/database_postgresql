...
CREATE FUNCTION "public"."udfAvailablePremium"("theMonth" integer, "theYear" integer, "theMode" integer, "ProdID" integer DEFAULT 0, "LocationId" integer DEFAULT 0) RETURNS TABLE("ProdId" integer, "Allocated" double precision, "Officer" character varying, "LastName" character varying, "OtherNames" character varying)
    LANGUAGE "plpgsql"
    AS $$
...
--
-- TOC entry 209 (class 1259 OID 20251)
...
--
-- TOC entry 211 (class 1259 OID 20261)
...
--
-- TOC entry 3328 (class 2604 OID 20264)
...
--
-- TOC entry 3384 (class 2606 OID 20258)
...
--
-- TOC entry 3389 (class 2606 OID 20287)
...
--
-- TOC entry 3392 (class 2606 OID 20266)
...
--
-- TOC entry 3386 (class 2606 OID 20256)
...
--
-- TOC entry 3382 (class 1259 OID 20275)
...
--
-- TOC entry 3387 (class 1259 OID 20288)
...
--
-- TOC entry 3390 (class 1259 OID 20289)
...
--
-- TOC entry 3728 (class 2606 OID 20404)
-- Name: core_User_groups core_User_groups_group_id_197830ae_fk_auth_group_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."core_User_groups"
    ADD CONSTRAINT "core_User_groups_group_id_197830ae_fk_auth_group_id" FOREIGN KEY ("group_id") REFERENCES "public"."auth_group"("id") DEFERRABLE INITIALLY DEFERRED;
